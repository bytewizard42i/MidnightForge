...
import { type ProtocolWalletBaseProviders } from '../common-types';
...
describe('Protocol Wallet Base', () => {
  ...
  let providers: ProtocolWalletBaseProviders;
  ...
  beforeAll(
    async () => {
      ...
      providers = await api.configureProtocolWalletBaseProviders(wallet, testConfiguration.dappConfig);
    },
    1000 * 60 * 45,
  );
